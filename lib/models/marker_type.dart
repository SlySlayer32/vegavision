...
class Marker {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'position': position != null ? {'x': position!.x, 'y': position!.y, 'z': position!.z} : null,
    };
  }

  Marker copyWith({double? x, double? y, MarkerType? type, String? customType, Vector3? position}) {
    return Marker(
      x: x ?? this.x,
      y: y ?? this.y,
      type: type ?? this.type,
