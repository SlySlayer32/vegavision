...
class GeminiServiceImpl implements GeminiService {
  ...
  Future<String?> editImage(
    ...
    try {
      ...
      final String modelName =
          options.model == ImageEditModel.geminiPro
              ? 'gemini-pro'
              : 'gemini-pro-vision';
  ...
  Future<List<String>> generateImageVariations(
    ...
    try {
      ...
      throw GeminiServiceException(
        'Failed to generate image variations: $e',
        originalError: e,
      );
    }
  }
  ...
  String _createEditPrompt(
    ...
    prompt.writeln(
      'Edit this image with the following instruction: $instruction',
    );
