    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed:
                viewModel.markers.isEmpty || viewModel.instruction.isEmpty
                    ? null
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: const Column(
              ...
              children: [
                Text(
                  '1. Tap on the image to place markers on objects you want to edit',
                ),
                SizedBox(height: 8),
                Text('2. Tap on a marker to remove it'),
                SizedBox(height: 8),
                Text(
                  '3. Enter a clear instruction describing what you want to do',
                ),
                SizedBox(height: 8),
